...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="w-full  items-center flex flex-col mt-10 font-sans md:px-10"
      ref={containerRef}
    >
      <div className=" flex px-3 max-w-7xl  items-center flex-col  mb-8 gap-6 justify-center ">
        ...
        <h2 className="text-md font-fira text-center font-semibold tracking-wide text-white/40">
          Final year computer science student at College of Engineering
          Trivandrum.
        </h2>
      </div>
